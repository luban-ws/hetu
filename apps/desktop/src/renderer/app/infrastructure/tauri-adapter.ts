...
const COMMAND_OVERRIDES: Record<string, string> = {
  ...
  'Secure-ClearCache': 'secure_clear_cache',
  'Settings-Init': 'settings_init',
  ...
  'AutoFetch-Start': 'auto_fetch_start',
  'AutoFetch-Stop': 'auto_fetch_stop',
