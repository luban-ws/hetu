...
describe('subscriptions.js', () => {
  describe('createEventSubscription', () => {
    it('should create a subscription that forwards all arguments', () => {
      ...
      const subscription = createEventSubscription('test-channel', mockCallback);
  ...
  describe('createCleanupFunction', () => {
    it('should create a cleanup function that calls removeListener', () => {
      ...
      const cleanup = createCleanupFunction(mockRemoveListener, channel, subscription);
    ...
    it('should be a pure function', () => {
      ...
      const cleanup1 = createCleanupFunction(mockRemoveListener, channel, subscription);
      const cleanup2 = createCleanupFunction(mockRemoveListener, channel, subscription);
